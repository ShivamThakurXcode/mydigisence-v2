...
export const metadata: Metadata = {
  ...
  description:
    'The unified platform for businesses, professionals, and creators. Build your digital identity, manage clients, take bookings, and grow — powered by AI.',
}
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pt-24 pb-20 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
          <Link
            href="/signup"
            className="h-12 px-8 rounded-lg bg-primary text-primary-foreground text-base font-medium hover:bg-primary/90 transition-colors flex items-center"
          >
            Start free — no credit card
          </Link>
          <Link
            href="/explore"
            className="h-12 px-8 rounded-lg border border-border text-base font-medium hover:bg-muted transition-colors flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {PERSONAS.map((persona) => (
            ...
            >
              ...
              <Link
                href={persona.cta}
                className="block text-center h-10 rounded-lg bg-primary text-primary-foreground text-sm font-medium leading-10 hover:bg-primary/90 transition-colors"
              >
                Get started
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {FEATURES.map((f) => (
              <div
                key={f.title}
                className="bg-card rounded-xl border border-border p-6 shadow-sm hover:border-primary/40 hover:shadow-md transition-all"
              >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
        <div className="bg-sidebar text-sidebar-foreground rounded-2xl p-10 md:p-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {['Dynamic Onboarding', 'Registry-Based Profiles', 'Widget Dashboards', 'AI Engine', 'Automation Engine', 'Search Engine'].map((t) => (
              <span
                key={t}
                className="px-4 py-1.5 rounded-full bg-sidebar-accent text-sidebar-accent-foreground text-sm font-medium"
              >
                {t}
              </span>
            ))}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 pb-24 text-center">
        ...
        <Link
          href="/signup"
          className="inline-flex items-center h-12 px-10 rounded-lg bg-primary text-primary-foreground text-base font-medium hover:bg-primary/90 transition-colors"
        >
