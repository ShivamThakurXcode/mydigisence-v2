            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              {BUSINESS_TYPES.map((bt) => (
                <button
                  ...
                  className={`p-4 rounded-xl border text-left transition-all hover:border-primary/50 ${businessType === bt.value ? 'border-primary bg-primary/5' : 'border-border bg-card'}`}
                >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  type="text" placeholder="Acme Agency" value={form.name}
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center">
                  ...
                  <input
                    type="text" placeholder="acme-agency" value={form.slug}
              ...
              <div className="space-y-2">
                ...
                <textarea
                  placeholder="What does your business do?" rows={3} value={form.description}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {Object.entries({
                ...
                <button
                  key={key}
                  onClick={() => setModules({ ...modules, [key]: !modules[key as keyof typeof modules] })}
                  className={`flex gap-3 p-4 rounded-xl border text-left transition-all ${modules[key as keyof typeof modules] ? 'border-primary bg-primary/5' : 'border-border bg-card hover:border-primary/30'}`}
                >
                  <span className="text-xl">{mod.emoji}</span>
                  <div>
                    <div className="text-sm font-medium flex items-center gap-2">
                      {mod.label}
                      {modules[key as keyof typeof modules] && <span className="w-4 h-4 rounded-full bg-primary flex items-center justify-center text-primary-foreground text-xs">✓</span>}
                    </div>
            ...
            <div className="flex gap-3">
              ...
              >{loading ? 'Creating workspace...' : 'Create workspace'}</button>
            </div>
          </div>
        )}
