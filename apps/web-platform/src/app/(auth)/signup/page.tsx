    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[['firstName', 'First name', 'John'], ['lastName', 'Last name', 'Doe']].map(([field, label, ph]) => (
            <div key={field} className="space-y-2">
              ...
              <input id={field} type="text" required placeholder={ph}
        ...
        <div className="space-y-2">
          ...
          <input id="password" type="password" autoComplete="new-password" required placeholder="Min. 8 chars, uppercase &amp; number"
        ...
        <p className="text-xs text-muted-foreground">
          By creating an account you agree to our <Link href="/legal/terms" className="underline hover:text-foreground">Terms</Link> and <Link href="/legal/privacy" className="underline hover:text-foreground">Privacy Policy</Link>.
        </p>
