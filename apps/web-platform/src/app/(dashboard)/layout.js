    ...
    return (<div className="flex h-screen overflow-hidden bg-background">
      ...
      <aside className="hidden md:flex w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
        ...
        <div className="h-16 flex items-center px-6 border-b border-sidebar-border">
          <link_1.default href="/" className="text-xl font-bold text-sidebar-foreground">
            MyDigiSence
          </link_1.default>
        </div>
        ...
        <nav className="flex-1 overflow-y-auto p-3 space-y-1">
          {NAV_ITEMS.map((item) => (<link_1.default key={item.href} href={`${basePath}${item.href}`} className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-sidebar-foreground/80 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors">
        ...
        <div className="p-3 border-t border-sidebar-border">
          <link_1.default href="/login" className="flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-sidebar-foreground/70 hover:bg-sidebar-accent transition-colors">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 border-b border-border flex items-center justify-between px-6 bg-background/80 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3">
            <link_1.default href={`/dashboard/${workspaceSlug}/notifications`} className="p-2 rounded-md hover:bg-muted relative">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
