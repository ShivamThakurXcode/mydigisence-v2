    ...
    <div className="space-y-6 max-w-6xl">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
        {PIPELINE_STAGES.map((stage) => (
          <div key={stage.label} className="bg-card rounded-xl border border-border p-4 shadow-sm text-center">
      ...
      <div className="overflow-x-auto pb-4">
        <div className="flex gap-4 min-w-max">
          {PIPELINE_STAGES.map((stage) => (
            <div key={stage.label} className="w-64 shrink-0">
        ...
        <div className="p-5 border-b border-border flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="h-8 px-3 rounded-md border border-input bg-background text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring w-48"
            />
